...
from qaltamda.bot_app.loader import dp, bot
from qaltamda.bot_app.handlers.common import router as common_router
from qaltamda.bot_app.handlers.categories import router as cat_router
from qaltamda.bot_app.handlers.expenses import router as exp_router
from qaltamda.bot_app.states import router as states_router
from qaltamda.bot_app.handlers.register import router as register_router
from qaltamda.bot_app.handlers.statistics import router as stats_router
